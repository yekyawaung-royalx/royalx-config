                                                       ...
                                                       +'<td>'+(item.Active == 1? '<span class="badge badge-center rounded-pill bg-success"><i class="bx bx-check"></i></span>':'<span class="badge badge-center rounded-pill bg-danger"><i class="bx bx-x"></i></span>')+'</td>'
                                                        +'<td>'
                                                                ...
                                                                +'<ul class="dropdown-menu dropdown-menu-end" style="">'
                                                                    +'<li ><a class="dropdown-item text-success  load-id" href="'+url+'/admin/routes/'+item.Id+'"  cursorshover="true"><span class="tf-icons bx bx-search" cursorshover="true"></span> View Route</a></li>'
                                                                    +'<li><a class="dropdown-item text-primary  load-id" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#EditTownship" cursorshover="true" title= '+item.Id+'><span class="tf-icons bx bx-pencil" cursorshover="true"></span> Edit Route</a></li>'
                                                                    +'<li><a class="dropdown-item text-success  edit-route '+(item.Active==1? 'hide':'')+'" href="javascript:void(0);" cursorshover="true" title= '+item.Id+' alt= '+item.Active+'><span class="tf-icons bx bx-show" cursorshover="true"></span> Open Route</a></li>'
                                                                    +'<li><a class="dropdown-item text-danger  edit-route '+(item.Active==0? 'hide':'')+'" href="javascript:void(0);" cursorshover="true" title= '+item.Id+' alt= '+item.Active+'><span class="tf-icons bx bx-hide" cursorshover="true"></span> Close Route</a></li>'
                                                                +'</ul>'
                                                             +'</div>'
                                                        +'</td>'
                                                +'</tr>');
                                                    ...
                                                    $("#fetched-data").append('<tr>'
                                                       ...
                                                       +'<td>'+(item.Active == 1? '<span class="badge badge-center rounded-pill bg-success"><i class="bx bx-check"></i></span>':'<span class="badge badge-center rounded-pill bg-danger"><i class="bx bx-x"></i></span>')+'</td>'
                                                        +'<td>'
                                                                ...
                                                                +'<ul class="dropdown-menu dropdown-menu-end" style="">'
                                                                    +'<li ><a class="dropdown-item text-success  load-id" href="'+url+'/admin/routes/'+item.Id+'"  cursorshover="true"><span class="tf-icons bx bx-search" cursorshover="true"></span> View Route</a></li>'
                                                                    +'<li><a class="dropdown-item text-primary  load-id" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#EditTownship" cursorshover="true" title= '+item.Active+'><span class="tf-icons bx bx-pencil" cursorshover="true"></span> Edit Item</a></li>'
                                                                    +'<li><a class="dropdown-item text-danger  load-id" href="javascript:void(0);" data-bs-toggle="modal" data-bs-target="#DeleteTownship" cursorshover="true" title= '+item.Active+'><span class="tf-icons bx bx-trash" cursorshover="true"></span> Delete Item</a></li>'
                                                                +'</ul>'
                                                             +'</div>'
                                                        +'</td>'
                                                +'</tr>');
