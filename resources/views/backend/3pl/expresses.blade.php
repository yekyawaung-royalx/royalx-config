...
<head>
        ...
        <meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=no, minimum-scale=1.0, maximum-scale=1.0" />
         ...
         <title>Royalx Core | 3PL Expresses</title>
        <!-- Favicon -->
                                                ...
                                                <div class="row">
                                                        <div class="col-md-4">
                                                                <h5 class="py-2 mb-2">
                                                                        ...
                                                                        <span class="text-muted fw-light"><i class="tf-icon bx bx-chevrons-right" cursorshover="true"></i> 3PL Expresses</span> 
                                                                </h5>
                                                        </div>
                                                        <div class="col-md-8">
                                                ...
                                                <div class="card mb-4">
                                                        ...
                                                        <div class="card-body results hide">
                                                                <div class="table-responsive text-nowrap">
                                                                        ...
                                                                        <thead>
                                                                                <tr>
                                                                                        <th class="text-muted unset">Express Name EN</th>
                                                                                        <th class="text-muted unset">Express Name MM</th>
                                        ...
                                        if(data.total > 0){
                                                $.each(data.data, function (i, item) {
                                                        $("#fetched-data").append('<tr>'
                                                         +'<td><span class="fw-semibold '+(item.Active == 1? "text-secondary":"text-danger" )+'">'+item.ExpressNameEn+'</span></td>'
                                                        +'<td><span class="text-secondary">'+item.ExpressNameMm+'</span></td>'                                                        
