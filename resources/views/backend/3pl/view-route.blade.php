...
<div class="card">
  ...
  <div class="card-body">
      <!-- Timeline Style -->
        ...
        <span class="text-light fw-medium">{{ $route->FromBranchName }} <i class="tf-icon bx bx-chevrons-right" cursorshover="true"></i> {{ $route->ToBranchName }} အထွက်လမ်းကြောင်းကားများ</span>
