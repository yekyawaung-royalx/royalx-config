                                        ...
                                        <div class="row">
                                                <div class="col-md-6">
                                                        <h5 class="py-2 mb-2">
                                                                ...
                                                                <a href="{{ url('admin/branches') }}" class="text-secondary fw-semibold"><i class="tf-icon bx bx-chevrons-right" cursorshover="true"></i> Branches </a> 
                                                                <span class="text-muted fw-light"><i class="tf-icon bx bx-chevrons-right" cursorshover="true"></i> View Branch </span> 
                                                        </h5>
                                                </div>
                                                <div class="col-md-8">
                                                                        ...
                                                                        <ul class="p-0 m-0">
                                                                                <li class="d-flex my-3 pb-1">
                                                                                        <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                                                                                <div class="me-2">
                                                                                                        <small class="text-muted d-block mb-1">Branch Name</small>
                                                                                                        <h6 class="mb-0">{{ $branch->BranchNameEn }} / {{ $branch->BranchNameMm }}&nbsp;</h6>
                                                                                                </div>
                                                                                        </div>
                                                                                </li>
                                                                                ...
                                                                                <li class="d-flex my-3 pb-1">
                                                                                        <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                                                                                <div class="me-2">
                                                                                                        ...
                                                                                                        <h6 class="mb-0">{{ $branch->Region }} &nbsp;</h6>
                                                                                                </div>
                                                                                        </div>
                                                                                </li>
                                                                                <li class="list-unstyled">
                                                                                ...
                                                                                <li class="d-flex my-3 pb-1">
                                                                                        <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                                                                                <div class="me-2">
                                                                                                        ...
                                                                                                        <h6 class="mb-0">{{ $branch->RegionCode }} &nbsp;</h6>
                                                                                                </div>
                                                                                        </div>
                                                                                </li>
                                                                                <li class="list-unstyled">
                                                                                ...
                                                                                <li class="d-flex my-3 pb-1">
                                                                                        <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                                                                                <div class="me-2">
                                                                                                        <small class="text-muted d-block mb-1">RegionPostalCode</small>
                                                                                                        <h6 class="mb-0">{{ $branch->RegionPostalCode }} &nbsp;</h6>
                                                                                                </div>
                                                                                        </div>
                                                                                </li>
                                                                                <li class="list-unstyled">
                                                                                ...
                                                                                <li class="d-flex my-3 pb-1">
                                                                                        <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                                                                                <div class="me-2">
                                                                                                        <small class="text-muted d-block mb-1">InternalCode</small>
                                                                                                        <h6 class="mb-0">{{ $branch->InternalCode }} &nbsp;</h6>
                                                                                                </div>
                                                                                        </div>
                                                                                </li>
                                                                                <li class="list-unstyled">
                                                                                ...
                                                                                <li class="d-flex my-3 pb-1">
                                                                                        <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                                                                                <div class="me-2">
                                                                                                        ...
                                                                                                        <h6 class="mb-0"><span class="badge bg-secondary">{{ $branch->Type }}</span> &nbsp;</h6>
                                                                                                </div>
                                                                                        </div>
                                                                                </li>
                                                                                <li class="list-unstyled">
                                                                                ...
                                                                                <li class="d-flex my-3 pb-1">
                                                                                        <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                                                                                <div class="me-2">
                                                                                                        <small class="text-muted d-block mb-1">BasedTownship</small>
                                                                                                        <h6 class="mb-0">{{ $branch->BasedTownship }} &nbsp;</h6>
                                                                                                </div>
                                                                                        </div>
                                                                                </li>
                                                                        </ul>
