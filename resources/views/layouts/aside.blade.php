    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item {{ request()->is('admin/3pl-services/*') ? 'open' : '' }}">
            ...
            <ul class="menu-sub">
                ...
                <li class="menu-item {{ request()->is('admin/3pl-services/related-branches') ? 'active' : '' }}">
                    <a href="{{ url('admin/3pl-services/related-branches') }}" class="menu-link">
                        <div data-i18n="Related Branches">Related Branches</div>
                    </a>
                </li>
            </ul>
        </li>
